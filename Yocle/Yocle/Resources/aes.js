...
//    expect(decrypt).toBe(plainText);
	//	document.getElementById("dd").innerHTML = "de="+decrypt;
		return decrypt;
}

function test() {
	var en = encrypt("123 abc 456789");
	var plain = decrypt(en);
