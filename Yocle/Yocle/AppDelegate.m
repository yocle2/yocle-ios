...
/*
    ...
    NSString *iv = @"qazwsxedcrfvtgby";//must be 16 or 16*i length
  ...
  //  NSData *encodeData =  [[textData dataUsingEncoding:NSUTF8StringEncoding] AES128EncryptWithKey:key iv:iv];
    NSString *aString = @"tLdSIcEaTgknjahgFiv1WPQXr7Km/LJi0ECIPa/8EMw=";
    
    NSData *encodeData = [[NSData alloc] initWithBase64EncodedString:aString options:0];
...
/*
    ...
    configuration.protocolClasses = @[[AllCacheTool class]];
    AFHTTPSessionManager *manager = [[AFHTTPSessionManager alloc]init];
    
    [manager POST:@"https://yolofolio2.cetl.hku.hk:18443" parameters:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
...
/*
    AFHTTPSessionManager *sessionManager = [[AFHTTPSessionManager alloc] initWithBaseURL:@"https://yolofolio2.cetl.hku.hk:18443" sessionConfiguration:configuration];
...
//    [NSURLProtocol registerClass:[CustomDataProtocol class]];
